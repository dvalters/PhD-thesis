...
class CaesarTimeseriesPlot(object):
    ...
    def plot_hydrograph(self, current_timeseries=None,
        ...
        line, = self.ax.plot(time_units, metric, linewidth=2, alpha=0.6)
    ...
    def set_labels(self):
        ...
        label_dic = {
          ...
          'd8': "d8 proportion",
          'd9': "d9 proportion",
          'cumulative_sed_tot' : r"Cumulative sediment yield ($m^3 \times 10^6$)",
        }
...
# OOP way
SwaleHydroS = CaesarTimeseriesPlot(data_dir, "*.dat", "cumulative_sed_tot",
