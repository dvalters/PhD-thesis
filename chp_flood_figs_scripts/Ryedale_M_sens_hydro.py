...
class CaesarTimeseriesPlot(object):
    ...
    def plot_ensemble_hydrograph(self, draw_inset=False):
        ...
        x_pos = [42.61, 43.14, 46.18, 46.18, 49.85, 53]
    ...
    def plot_external_data(self, filename):
        ...
        line, = self.ax.plot(hours -1, y, '--k', linewidth=2)
...
data_dir = "/run/media/dav/SHETLAND/Analyses/Topmodel_Sensitivity/Ryedale_storms_calibrate_gridded/"
